...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Sat Sep  3 03:41:18 EDT 2016
...
PCI_DEV_TABLE devs[] = {
	{ "8168", "PCIe GBE" },
	{ "08B4", "PCI Parallel Card" },
	{ "0F00", "Intel(R) Pentium(R)/Celeron(R) processor N-/J- series SoC Transaction Router" },
	{ "0F04", "High Definition Audio Controller" },
	{ "0F12", "Intel(R) Pentium(R)/Celeron(R) processor N-/J- series Platform Control Unit - SMBus Port" },
	{ "0F18", "Intel(R) Trusted Execution Engine Interface" },
	{ "0F23", "Intel(R) Pentium(R)/Celeron(R) processor N-/J- series AHCI" },
	{ "0F31", "Iris pro 5200" },
	{ "0F34", "Atom(TM)/Celeron(R)/Pentium(R) Processor EHCI USB - 0F34" },
	{ "0F48", "Intel(R) Pentium(R)/Celeron(R) processor N-/J- series PCI Express Root Port" },
	{ "0F4C", "USB webcam" },
	{ "0F4E", "Intel(R) Pentium(R)/Celeron(R) processor N-/J- series PCI Express Root Port	" },
};
